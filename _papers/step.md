---
title: "Streaming Tensor Programs (STeP): A Streaming Abstraction for Dynamic Parallelism"
venue: ASPLOS
year: 2026
authors: "Gina Sohn, Genghan Zhang, Konstantin Hossfeld, Jungwoo Kim, Nathan Sobotka, Nathan Zhang, Olivia Hsu, Kunle Olukotun"
summary: "面向空间数据流加速器的流式抽象，支持动态 tiling 与动态并行，加速 LLM 中的 MoE 等动态张量程序。"
tags: [SDA, LLM, MoE, streaming]
links:
  - label: Artifact
