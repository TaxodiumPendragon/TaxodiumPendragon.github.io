...
venue: ISCA
year: 2025
authors: "Souradip Ghosh, Brandon Lucia, Nathan Beckmann, Tony Nowatzki, Graham Gobieski, Keyi Zhang"
summary: "通过非统一 PE 访存（NUPEA）与编译器关键负载放置，降低大型 SDA 上的数据移动开销。"
tags: [SDA, NUPEA, compiler, NoC]
---
