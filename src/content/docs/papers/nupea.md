---
title: "NUPEA: Optimizing Critical Loads on Spatial Dataflow Architectures via
  Non-Uniform Processing-Element Access"
description: 通过非统一 PE 访存（NUPEA）与编译器关键负载放置，降低大型 SDA 上的数据移动开销。
venue: ISCA
year: 2025
authors: Souradip Ghosh, Brandon Lucia, Nathan Beckmann, Tony Nowatzki, Graham
  Gobieski, Keyi Zhang
tags:
  - SDA
  - NUPEA
